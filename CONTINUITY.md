...
- 2026-03-02: Added `EXTERNAL_APP_JSON_CONTRACT.md` documenting downstream consumption paths, update cadence, and JSON schema/field contracts for `data/processed/rss_openai_precomputed.json` and `data/rss_openai_daily.json`.
